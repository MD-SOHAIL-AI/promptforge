...
[![Version](https://img.shields.io/badge/version-v1.0.0--rc-blue?style=flat-square)](https://github.com/your-org/promptforge/releases)
[![Tests](https://img.shields.io/badge/tests-1096%20passing-brightgreen?style=flat-square)](https://github.com/your-org/promptforge/actions)
...
![PlatformIO](https://img.shields.io/badge/PlatformIO-integrated-orange?style=flat-square&logo=platformio&logoColor=white)
...
**Current status:** `v1.0.0-rc` — Release Candidate. Core workflow is stable; all 1 096 tests are passing.
...
PromptForge has a layered test suite with **1 096 tests** across four categories.
...
| **Total** | **1 096** | All passing on `main` |
...
[Report a Bug](https://github.com/your-org/promptforge/issues) · [Request a Feature](https://github.com/your-org/promptforge/issues) · [Discussions](https://github.com/your-org/promptforge/discussions)

© 2025 PromptForge Contributors · MIT License