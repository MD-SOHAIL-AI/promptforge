...
function row(label: string, value: string) {
  return (
    <div className="grid gap-1 border-b border-[var(--fx-border)] py-2 text-sm last:border-b-0 sm:grid-cols-[170px_minmax(0,1fr)] sm:gap-3">
...
export function AboutSettings({ health }: AboutSettingsProps) {
  ...
  return (
    <div className="grid gap-4">
      <section className="fx-card min-w-0 p-5">
