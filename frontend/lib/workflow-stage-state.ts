...
const eventStages: Partial<Record<ExecutionEventName, StageKey>> = {
  ...
  PROJECT_VALIDATION_STARTED: "generation",
  PROJECT_VALIDATION_FAILED: "generation",
  PROJECT_VALIDATION_COMPLETED: "generation",
  PROJECT_REPAIR_STARTED: "generation",
  PROJECT_REPAIR_COMPLETED: "generation",
  PROJECT_REPAIR_FAILED: "generation",
  BUILD_BLOCKED: "build",
  BUILD_STARTED: "build",
...
function statusForStageEvent(event: ExecutionEvent): StageStatus {
  ...
  if (event.event === "PROJECT_VALIDATION_COMPLETED") return "success";
  if (
    event.event === "GENERATION_COMPLETED" ||
    event.event === "PROJECT_VALIDATION_STARTED" ||
    event.event === "PROJECT_VALIDATION_FAILED" ||
    event.event === "PROJECT_REPAIR_STARTED" ||
    event.event === "PROJECT_REPAIR_COMPLETED"
  ) {
    return "active";
  }
  if (
