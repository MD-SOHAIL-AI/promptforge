...
def test_control_plane_required_flags_are_not_hardware_peripherals(engine: ConstraintEngine) -> None:
    result = engine.validate_constraints(
        "ESP32",
        {"workspace_generation_required": True, "reviewer_required": True},
    )
