"""Canonical generated firmware project models for ForgeX.
...
class BuildArtifact:
    ...
    def __post_init__(self) -> None:
        ...
        if isinstance(path, Path):
            ...
            # Persist one platform-neutral path representation. Filesystem
            # conversion belongs at the host boundary, not in serialized data.
            path = path.replace("\\", "/")
